...
Neste [link contém a imagem demonstrativa do menu inicial da calculadora](https://github.com/isagopal/calculadora-em-texto-em-C-com-README/blob/main/assets/MENU-INICIAL.png).
